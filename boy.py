...
class StateMachine:
    def __init__(self,boy):
        ...
        self.cur_state = Idle
        self.table={
            Idle: {right_down: Run, left_down: Run, left_up: Run, right_up: Run, time_out: Sleep,auto_down:AutoRun},
            Run: {right_down: Idle, left_down: Idle, right_up: Idle, left_up: Idle,auto_down:AutoRun},
            Sleep: {right_down: Run, left_down: Run, right_up: Run, left_up: Run, space_down: Idle,auto_down:AutoRun},
